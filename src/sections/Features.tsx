    ...
    >
      ...
      {props.selected && (
        <motion.div
          ...
          className="absolute inset-0 -mx-px border border-[#a369ff] rounded-xl">
        </motion.div>
      )}
      ...
      {props.isNew && <div className="text-xs rounded-full px-2 py-0.5 bg-[#8c44ff] text-white font-semibold">new</div>}
    </div>
  )
}
  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        <h2 className="text-5xl md:text-6xl font-medium text-center tracking-tighter text-balance">Elevate your SEO efforts.</h2>
        <p className="text-white/70 text-lg md:text-xl max-w-2xl mx-auto tracking-tight text-center mt-5">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Fugit distinctio commodi id vero vel perspiciatis nostrum repellendus.</p>
