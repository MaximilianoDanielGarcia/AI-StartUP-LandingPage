  ...
  return (
    <motion.section
      ...
      <div className="container relative mt-16">
        ...
        <p className="text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem totam ex beatae iusto tempore inventore pariatur error eaque.</p>
